    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <Text style={styles.title}>Cadastre seu primeiro pet</Text>
          <Text style={styles.subtitle}>Conte-nos um pouco sobre seu companheiro para personalizarmos sua experiência.</Text>
        </View>
